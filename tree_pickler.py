...
interview_tree = ['Attribute', 'level', 
                        ['Value', 'Junior', 
                            ['Attribute', 'phd', 
                                ['Value', 'yes', 
                                    ['Leaf', 'False', 2, 5]], 
...
# in another python process, possibly running on a different machine (server)
# imagine you just trained MyRandomForestClassifier
...
pickle.dumps(packaged_obj, outfile)
outfile.close()